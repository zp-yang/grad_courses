...
function [sys,x0,str,ts] = sfun_dpend(t,x,u,flag,x0,P)
...
sizes=simsizes;
sizes.NumContStates = 3;		%Set number of continuous-time state variables
sizes.NumDiscStates = 0;
sizes.NumOutputs = 3;			%Set number of outputs
